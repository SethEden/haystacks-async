...
export const applicationConstantsValidation = [
  ...
  {
    Name: "cPluginsRegistryCommonPath",
    Actual: apc.cPluginsRegistryCommonPath,
    Expected: "plugins/plugins.json",
  },
  {
  ...
  {
    Name: "cThemesCommonPath",
    Actual: apc.cThemesCommonPath,
    Expected: "themes/",
  },
  ...
  {
    Name: "cFullDevPluginsRegistryPath",
    Actual: apc.cFullDevPluginsRegistryPath,
    Expected: "/src/resources/plugins/plugins.json",
  },
  {
  ...
  {
    Name: "cFullDevThemesPath",
    Actual: apc.cFullDevThemesPath,
    Expected: "/src/resources/themes/",
  },
  {
  ...
  {
    Name: "cFullProdPluginsRegistryPath",
    Actual: apc.cFullProdPluginsRegistryPath,
    Expected: "/bin/resources/plugins/plugins.json",
  },
  {
  ...
  {
    Name: "cFullProdThemesPath",
    Actual: apc.cFullProdThemesPath,
    Expected: "/bin/resources/themes/",
  },
  {
