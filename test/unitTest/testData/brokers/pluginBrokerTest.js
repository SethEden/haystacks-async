...
export const cexpectedDataFromPluginsJsonFile = {
    [wrd.cpath]: rootPathAsync + bas.cForwardSlash + wrd.ctest + bas.cForwardSlash + wrd.cunit + wrd.cTest + bas.cForwardSlash + wrd.ctest + wrd.cData + bas.cForwardSlash + wrd.ctest + wrd.cPlugins,
    [wrd.cplugins]: [{
