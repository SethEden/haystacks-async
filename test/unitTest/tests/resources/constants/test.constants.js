...
export const cgetLengthOfLongestStringInArray = biz.cgetLengthOfLongestStringInArray; // getLengthOfLongestStringInArray
export const csearchForPatternsInStringArray = biz.csearchForPatternsInStringArray; // searchForPatternsInStringArray
export const cvalidatePatternsThatNeedImplementation = biz.cvalidatePatternsThatNeedImplementation; // validatePatternsThatNeedImplementation
...
export const cvalidateConstantsDataValidationLineItemName = biz.cvalidateConstantsDataValidationLineItemName; // validateConstantsDataValidationLineItemName
export const cgetConstantsValidationNamespaceParentObject = biz.cgetConstantsValidationNamespaceParentObject; // getConstantsValidationNamespaceParentObject
export const cdoesConstantNamespaceExist = biz.cdoesConstantNamespaceExist; // doesConstantNamespaceExist
export const cdoesConstantExist = biz.cdoesConstantExist; // doesConstantExist
export const cdoesConstantExistInConstantLibraryObject = biz.cdoesConstantExistInConstantLibraryObject; // doesConstantExistInConstantLibraryObject
export const cgetConstantTypeInConstantLibraryObject = biz.cgetConstantTypeInConstantLibraryObject; // getConstantTypeInConstantLibraryObject
export const cgetConstantNameInConstantLibraryObject = biz.cgetConstantNameInConstantLibraryObject; // getConstantNameInConstantLibraryObject
export const cgetConstantActualValueInConstantLibraryObject = biz.cgetConstantActualValueInConstantLibraryObject; // getConstantActualValueInConstantLibraryObject
export const cdoesConstantExistInConstantNamespaceObject = biz.cdoesConstantExistInConstantNamespaceObject; // doesConstantExistInConstantNamespaceObject
export const cgetConstantNameInConstantNamespaceObject = biz.cgetConstantNameInConstantNamespaceObject; // getConstantNameInConstantNamespaceObject
export const cgetConstantActualValueInConstantNamespaceObject = biz.cgetConstantActualValueInConstantNamespaceObject; // getConstantActualValueInConstantNamespaceObject
...
export const cgetLengthOfLongestStringInArray_validData = cgetLengthOfLongestStringInArray + bas.cUnderscore + wrd.cvalid + wrd.cData; // getLengthOfLongestStringInArray_validData
export const cgetLengthOfLongestStringInArray_inValidInputDataString = cgetLengthOfLongestStringInArray + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // getLengthOfLongestStringInArray_inValidInputDataString
export const cgetLengthOfLongestStringInArray_inValidInputDataInteger = cgetLengthOfLongestStringInArray + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // getLengthOfLongestStringInArray_inValidInputDataInteger
export const cgetLengthOfLongestStringInArray_inValidInputDataBoolean = cgetLengthOfLongestStringInArray + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // getLengthOfLongestStringInArray_inValidInputDataBoolean
export const cgetLengthOfLongestStringInArray_inValidInputDataUndefined = cgetLengthOfLongestStringInArray + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // getLengthOfLongestStringInArray_inValidInputDataUndefined
export const cgetLengthOfLongestStringInArray_inValidInputDataNaN = cgetLengthOfLongestStringInArray + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // getLengthOfLongestStringInArray_inValidInputDataNaN

// searchForPatternsInStringArray
export const csearchForPatternsInStringArray_validData = csearchForPatternsInStringArray + bas.cUnderscore + wrd.cvalid + wrd.cData; // searchForPatternsInStringArray_validData
export const csearchForPatternsInStringArray_inValidInputDataString = csearchForPatternsInStringArray + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // searchForPatternsInStringArray_inValidInputDataString
export const csearchForPatternsInStringArray_inValidInputDataInteger = csearchForPatternsInStringArray + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // searchForPatternsInStringArray_inValidInputDataInteger
export const csearchForPatternsInStringArray_inValidInputDataBoolean = csearchForPatternsInStringArray + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // searchForPatternsInStringArray_inValidInputDataBoolean
export const csearchForPatternsInStringArray_inValidInputDataUndefined = csearchForPatternsInStringArray + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // searchForPatternsInStringArray_inValidInputDataUndefined
export const csearchForPatternsInStringArray_inValidInputDataNaN = csearchForPatternsInStringArray + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // searchForPatternsInStringArray_inValidInputDataNaN

// validatePatternsThatNeedImplementation
export const cvalidatePatternsThatNeedImplementation_validData = cvalidatePatternsThatNeedImplementation + bas.cUnderscore + wrd.cvalid + wrd.cData; // validatePatternsThatNeedImplementation_validData
export const cvalidatePatternsThatNeedImplementation_inValidInputDataString = cvalidatePatternsThatNeedImplementation + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // validatePatternsThatNeedImplementation_inValidInputDataString
export const cvalidatePatternsThatNeedImplementation_inValidInputDataInteger = cvalidatePatternsThatNeedImplementation + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // validatePatternsThatNeedImplementation_inValidInputDataInteger
export const cvalidatePatternsThatNeedImplementation_inValidInputDataBoolean = cvalidatePatternsThatNeedImplementation + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // validatePatternsThatNeedImplementation_inValidInputDataBoolean
export const cvalidatePatternsThatNeedImplementation_inValidInputDataUndefined = cvalidatePatternsThatNeedImplementation + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // validatePatternsThatNeedImplementation_inValidInputDataUndefined
export const cvalidatePatternsThatNeedImplementation_inValidInputDataNaN = cvalidatePatternsThatNeedImplementation + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // validatePatternsThatNeedImplementation_inValidInputDataNaN

/* dataArrayParsing */
// arraysAreEqual
export const carraysAreEqual_validData = carraysAreEqual + bas.cUnderscore + wrd.cvalid + wrd.cData; // arraysAreEqual_validData
export const carraysAreEqual_inValidInputDataString = carraysAreEqual + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // arraysAreEqual_inValidInputDataString
export const carraysAreEqual_inValidInputMetaDataString = carraysAreEqual + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cString; // arraysAreEqual_inValidInputMetaDataString
export const carraysAreEqual_inValidInputDataInteger = carraysAreEqual + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // arraysAreEqual_inValidInputDataInteger
export const carraysAreEqual_inValidInputDataBoolean = carraysAreEqual + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // arraysAreEqual_inValidInputDataBoolean
export const carraysAreEqual_inValidInputMetaDataInteger = carraysAreEqual + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cInteger; // arraysAreEqual_inValidInputMetaDataInteger
export const carraysAreEqual_inValidInputMetaDataBoolean = carraysAreEqual + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cBoolean; // arraysAreEqual_inValidInputMetaDataBoolean
export const carraysAreEqual_inValidInputDataUndefined = carraysAreEqual + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // arraysAreEqual_inValidInputDataUndefined
export const carraysAreEqual_inValidInputDataNaN = carraysAreEqual + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // arraysAreEqual_inValidInputDataNaN
export const carraysAreEqual_inValidInputMetaDataUndefined = carraysAreEqual + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'Undefined'; // arraysAreEqual_inValidInputMetaDataUndefined
export const carraysAreEqual_inValidInputMetaDataNaN = carraysAreEqual + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'NaN'; // arraysAreEqual_inValidInputMetaDataNaN

// storeData
export const cstoreData_inValidInputDataInteger = cstoreData + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // storeData_inValidInputDataInteger
export const cstoreData_inValidInputDataBoolean = cstoreData + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // storeData_inValidInputDataBoolean
export const cstoreData_inValidInputMetaDataBoolean = cstoreData + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cBoolean; // storeData_inValidInputMetaDataBoolean
export const cstoreData_inValidInputDataUndefined = cstoreData + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // storeData_inValidInputDataUndefined
export const cstoreData_inValidInputDataNaN = cstoreData + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // storeData_inValidInputDataNaN
export const cstoreData_inValidInputMetaDataUndefined = cstoreData + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'Undefined'; // storeData_inValidInputMetaDataUndefined
export const cstoreData_inValidInputMetaDataNaN = cstoreData + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'NaN'; // storeData_inValidInputMetaDataNaN

// getStoredData
export const cgetStoredData_validData = cgetStoredData + bas.cUnderscore + wrd.cvalid + wrd.cData; // getStoredData_validData
export const cgetStoredData_inValidInputDataString = cgetStoredData + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // getStoredData_inValidInputDataString
export const cgetStoredData_inValidInputDataInteger = cgetStoredData + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // getStoredData_inValidInputDataInteger
export const cgetStoredData_inValidInputDataBoolean = cgetStoredData + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // getStoredData_inValidInputDataBoolean
export const cgetStoredData_inValidInputDataUndefined = cgetStoredData + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // getStoredData_inValidInputDataUndefined
export const cgetStoredData_inValidInputDataNaN = cgetStoredData + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // getStoredData_inValidInputDataNaN

// isObjectEmpty
export const cisObjectEmpty_validData = cisObjectEmpty + bas.cUnderscore + wrd.cvalid + wrd.cData; // isObjectEmpty_validData
export const cisObjectEmpty_inValidInputDataString = cisObjectEmpty + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // isObjectEmpty_inValidInputDataString
export const cisObjectEmpty_inValidInputDataInteger = cisObjectEmpty + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // isObjectEmpty_inValidInputDataInteger
export const cisObjectEmpty_inValidInputDataBoolean = cisObjectEmpty + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // isObjectEmpty_inValidInputDataBoolean
...
export const cvalidateConstantsDataValidationLineItemName_validData = cvalidateConstantsDataValidationLineItemName + bas.cUnderscore + wrd.cvalid + wrd.cData; // validateConstantsDataValidationLineItemName_validData
export const cvalidateConstantsDataValidationLineItemName_inValidInputDataString = cvalidateConstantsDataValidationLineItemName + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // validateConstantsDataValidationLineItemName_inValidInputDataString
export const cvalidateConstantsDataValidationLineItemName_inValidInputMetaDataString = cvalidateConstantsDataValidationLineItemName + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cString; // validateConstantsDataValidationLineItemName_inValidInputMetaDataString
export const cvalidateConstantsDataValidationLineItemName_inValidInputDataInteger = cvalidateConstantsDataValidationLineItemName + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // validateConstantsDataValidationLineItemName_inValidInputDataInteger
export const cvalidateConstantsDataValidationLineItemName_inValidInputDataBoolean = cvalidateConstantsDataValidationLineItemName + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // validateConstantsDataValidationLineItemName_inValidInputDataBoolean
export const cvalidateConstantsDataValidationLineItemName_inValidInputMetaDataInteger = cvalidateConstantsDataValidationLineItemName + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cInteger; // validateConstantsDataValidationLineItemName_inValidInputMetaDataInteger
export const cvalidateConstantsDataValidationLineItemName_inValidInputMetaDataBoolean = cvalidateConstantsDataValidationLineItemName + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cBoolean; // validateConstantsDataValidationLineItemName_inValidInputMetaDataBoolean
export const cvalidateConstantsDataValidationLineItemName_inValidInputDataUndefined = cvalidateConstantsDataValidationLineItemName + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // validateConstantsDataValidationLineItemName_inValidInputDataUndefined
export const cvalidateConstantsDataValidationLineItemName_inValidInputDataNaN = cvalidateConstantsDataValidationLineItemName + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // validateConstantsDataValidationLineItemName_inValidInputDataNaN
export const cvalidateConstantsDataValidationLineItemName_inValidInputMetaDataUndefined = cvalidateConstantsDataValidationLineItemName + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'Undefined'; // validateConstantsDataValidationLineItemName_inValidInputMetaDataUndefined
export const cvalidateConstantsDataValidationLineItemName_inValidInputMetaDataNaN = cvalidateConstantsDataValidationLineItemName + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'NaN'; // validateConstantsDataValidationLineItemName_inValidInputMetaDataNaN

// getConstantsValidationNamespaceParentObject
export const cgetConstantsValidationNamespaceParentObject_validData = cgetConstantsValidationNamespaceParentObject + bas.cUnderscore + wrd.cvalid + wrd.cData; // getConstantsValidationNamespaceParentObject_validData
export const cgetConstantsValidationNamespaceParentObject_inValidInputDataString = cgetConstantsValidationNamespaceParentObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // getConstantsValidationNamespaceParentObject_inValidInputDataString
export const cgetConstantsValidationNamespaceParentObject_inValidInputMetaDataString = cgetConstantsValidationNamespaceParentObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cString; // getConstantsValidationNamespaceParentObject_inValidInputMetaDataString
export const cgetConstantsValidationNamespaceParentObject_inValidInputDataInteger = cgetConstantsValidationNamespaceParentObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // getConstantsValidationNamespaceParentObject_inValidInputDataInteger
export const cgetConstantsValidationNamespaceParentObject_inValidInputDataBoolean = cgetConstantsValidationNamespaceParentObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // getConstantsValidationNamespaceParentObject_inValidInputDataBoolean
export const cgetConstantsValidationNamespaceParentObject_inValidInputMetaDataInteger = cgetConstantsValidationNamespaceParentObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cInteger; // getConstantsValidationNamespaceParentObject_inValidInputMetaDataInteger
export const cgetConstantsValidationNamespaceParentObject_inValidInputMetaDataBoolean = cgetConstantsValidationNamespaceParentObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cBoolean; // getConstantsValidationNamespaceParentObject_inValidInputMetaDataBoolean
export const cgetConstantsValidationNamespaceParentObject_inValidInputDataUndefined = cgetConstantsValidationNamespaceParentObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // getConstantsValidationNamespaceParentObject_inValidInputDataUndefined
export const cgetConstantsValidationNamespaceParentObject_inValidInputDataNaN = cgetConstantsValidationNamespaceParentObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // getConstantsValidationNamespaceParentObject_inValidInputDataNaN
export const cgetConstantsValidationNamespaceParentObject_inValidInputMetaDataUndefined = cgetConstantsValidationNamespaceParentObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'Undefined'; // getConstantsValidationNamespaceParentObject_inValidInputMetaDataUndefined
export const cgetConstantsValidationNamespaceParentObject_inValidInputMetaDataNaN = cgetConstantsValidationNamespaceParentObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'NaN'; // getConstantsValidationNamespaceParentObject_inValidInputMetaDataNaN

// doesConstantNamespaceExist
export const cdoesConstantNamespaceExist_validData = cdoesConstantNamespaceExist + bas.cUnderscore + wrd.cvalid + wrd.cData; // doesConstantNamespaceExist_validData
export const cdoesConstantNamespaceExist_inValidInputDataString = cdoesConstantNamespaceExist + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // doesConstantNamespaceExist_inValidInputDataString
export const cdoesConstantNamespaceExist_inValidInputMetaDataString = cdoesConstantNamespaceExist + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cString; // doesConstantNamespaceExist_inValidInputMetaDataString
export const cdoesConstantNamespaceExist_inValidInputDataInteger = cdoesConstantNamespaceExist + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // doesConstantNamespaceExist_inValidInputDataInteger
export const cdoesConstantNamespaceExist_inValidInputDataBoolean = cdoesConstantNamespaceExist + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // doesConstantNamespaceExist_inValidInputDataBoolean
export const cdoesConstantNamespaceExist_inValidInputMetaDataInteger = cdoesConstantNamespaceExist + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cInteger; // doesConstantNamespaceExist_inValidInputMetaDataInteger
export const cdoesConstantNamespaceExist_inValidInputMetaDataBoolean = cdoesConstantNamespaceExist + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cBoolean; // doesConstantNamespaceExist_inValidInputMetaDataBoolean
export const cdoesConstantNamespaceExist_inValidInputDataUndefined = cdoesConstantNamespaceExist + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // doesConstantNamespaceExist_inValidInputDataUndefined
export const cdoesConstantNamespaceExist_inValidInputDataNaN = cdoesConstantNamespaceExist + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // doesConstantNamespaceExist_inValidInputDataNaN
export const cdoesConstantNamespaceExist_inValidInputMetaDataUndefined = cdoesConstantNamespaceExist + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'Undefined'; // doesConstantNamespaceExist_inValidInputMetaDataUndefined
export const cdoesConstantNamespaceExist_inValidInputMetaDataNaN = cdoesConstantNamespaceExist + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'NaN'; // doesConstantNamespaceExist_inValidInputMetaDataNaN

// doesConstantExist
export const cdoesConstantExist_validData = cdoesConstantExist + bas.cUnderscore + wrd.cvalid + wrd.cData; // doesConstantExist_validData
export const cdoesConstantExist_inValidInputDataString = cdoesConstantExist + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // doesConstantExist_inValidInputDataString
export const cdoesConstantExist_inValidInputDataInteger = cdoesConstantExist + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // doesConstantExist_inValidInputDataInteger
export const cdoesConstantExist_inValidInputDataBoolean = cdoesConstantExist + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // doesConstantExist_inValidInputDataBoolean
export const cdoesConstantExist_inValidInputDataUndefined = cdoesConstantExist + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // doesConstantExist_inValidInputDataUndefined
export const cdoesConstantExist_inValidInputDataNaN = cdoesConstantExist + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // doesConstantExist_inValidInputDataNaN

// doesConstantExistInConstantLibraryObject
export const cdoesConstantExistInConstantLibraryObject_validData = cdoesConstantExistInConstantLibraryObject + bas.cUnderscore + wrd.cvalid + wrd.cData; // doesConstantExistInConstantLibraryObject_validData
export const cdoesConstantExistInConstantLibraryObject_inValidInputDataString = cdoesConstantExistInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // doesConstantExistInConstantLibraryObject_inValidInputDataString
export const cdoesConstantExistInConstantLibraryObject_inValidInputMetaDataString = cdoesConstantExistInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cString; // doesConstantExistInConstantLibraryObject_inValidInputMetaDataString
export const cdoesConstantExistInConstantLibraryObject_inValidInputDataInteger = cdoesConstantExistInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // doesConstantExistInConstantLibraryObject_inValidInputDataInteger
export const cdoesConstantExistInConstantLibraryObject_inValidInputDataBoolean = cdoesConstantExistInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // doesConstantExistInConstantLibraryObject_inValidInputDataBoolean
export const cdoesConstantExistInConstantLibraryObject_inValidInputMetaDataInteger = cdoesConstantExistInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cInteger; // doesConstantExistInConstantLibraryObject_inValidInputMetaDataInteger
export const cdoesConstantExistInConstantLibraryObject_inValidInputMetaDataBoolean = cdoesConstantExistInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cBoolean; // doesConstantExistInConstantLibraryObject_inValidInputMetaDataBoolean
export const cdoesConstantExistInConstantLibraryObject_inValidInputDataUndefined = cdoesConstantExistInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // doesConstantExistInConstantLibraryObject_inValidInputDataUndefined
export const cdoesConstantExistInConstantLibraryObject_inValidInputDataNaN = cdoesConstantExistInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // doesConstantExistInConstantLibraryObject_inValidInputDataNaN
export const cdoesConstantExistInConstantLibraryObject_inValidInputMetaDataUndefined = cdoesConstantExistInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'Undefined'; // doesConstantExistInConstantLibraryObject_inValidInputMetaDataUndefined
export const cdoesConstantExistInConstantLibraryObject_inValidInputMetaDataNaN = cdoesConstantExistInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'NaN'; // doesConstantExistInConstantLibraryObject_inValidInputMetaDataNaN

// getConstantTypeInConstantLibraryObject
export const cgetConstantTypeInConstantLibraryObject_validData = cgetConstantTypeInConstantLibraryObject + bas.cUnderscore + wrd.cvalid + wrd.cData; // getConstantTypeInConstantLibraryObject_validData
export const cgetConstantTypeInConstantLibraryObject_inValidInputDataString = cgetConstantTypeInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // getConstantTypeInConstantLibraryObject_inValidInputDataString
export const cgetConstantTypeInConstantLibraryObject_inValidInputMetaDataString = cgetConstantTypeInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cString; // getConstantTypeInConstantLibraryObject_inValidInputMetaDataString
export const cgetConstantTypeInConstantLibraryObject_inValidInputDataInteger = cgetConstantTypeInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // getConstantTypeInConstantLibraryObject_inValidInputDataInteger
export const cgetConstantTypeInConstantLibraryObject_inValidInputDataBoolean = cgetConstantTypeInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // getConstantTypeInConstantLibraryObject_inValidInputDataBoolean
export const cgetConstantTypeInConstantLibraryObject_inValidInputMetaDataInteger = cgetConstantTypeInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cInteger; // getConstantTypeInConstantLibraryObject_inValidInputMetaDataInteger
export const cgetConstantTypeInConstantLibraryObject_inValidInputMetaDataBoolean = cgetConstantTypeInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cBoolean; // getConstantTypeInConstantLibraryObject_inValidInputMetaDataBoolean
export const cgetConstantTypeInConstantLibraryObject_inValidInputDataUndefined = cgetConstantTypeInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // getConstantTypeInConstantLibraryObject_inValidInputDataUndefined
export const cgetConstantTypeInConstantLibraryObject_inValidInputDataNaN = cgetConstantTypeInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // getConstantTypeInConstantLibraryObject_inValidInputDataNaN
export const cgetConstantTypeInConstantLibraryObject_inValidInputMetaDataUndefined = cgetConstantTypeInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'Undefined'; // getConstantTypeInConstantLibraryObject_inValidInputMetaDataUndefined
export const cgetConstantTypeInConstantLibraryObject_inValidInputMetaDataNaN = cgetConstantTypeInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'NaN'; // getConstantTypeInConstantLibraryObject_inValidInputMetaDataNaN

// getConstantNameInConstantLibraryObject
export const cgetConstantNameInConstantLibraryObject_validData = cgetConstantNameInConstantLibraryObject + bas.cUnderscore + wrd.cvalid + wrd.cData; // getConstantNameInConstantLibraryObject_validData
export const cgetConstantNameInConstantLibraryObject_inValidInputDataString = cgetConstantNameInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // getConstantNameInConstantLibraryObject_inValidInputDataString
export const cgetConstantNameInConstantLibraryObject_inValidInputMetaDataString = cgetConstantNameInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cString; // getConstantNameInConstantLibraryObject_inValidInputMetaDataString
export const cgetConstantNameInConstantLibraryObject_inValidInputDataInteger = cgetConstantNameInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // getConstantNameInConstantLibraryObject_inValidInputDataInteger
export const cgetConstantNameInConstantLibraryObject_inValidInputDataBoolean = cgetConstantNameInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // getConstantNameInConstantLibraryObject_inValidInputDataBoolean
export const cgetConstantNameInConstantLibraryObject_inValidInputMetaDataInteger = cgetConstantNameInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cInteger; // getConstantNameInConstantLibraryObject_inValidInputMetaDataInteger
export const cgetConstantNameInConstantLibraryObject_inValidInputMetaDataBoolean = cgetConstantNameInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cBoolean; // getConstantNameInConstantLibraryObject_inValidInputMetaDataBoolean
export const cgetConstantNameInConstantLibraryObject_inValidInputDataUndefined = cgetConstantNameInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // getConstantNameInConstantLibraryObject_inValidInputDataUndefined
export const cgetConstantNameInConstantLibraryObject_inValidInputDataNaN = cgetConstantNameInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // getConstantNameInConstantLibraryObject_inValidInputDataNaN
export const cgetConstantNameInConstantLibraryObject_inValidInputMetaDataUndefined = cgetConstantNameInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'Undefined'; // getConstantNameInConstantLibraryObject_inValidInputMetaDataUndefined
export const cgetConstantNameInConstantLibraryObject_inValidInputMetaDataNaN = cgetConstantNameInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'NaN'; // getConstantNameInConstantLibraryObject_inValidInputMetaDataNaN

// getConstantActualValueInConstantLibraryObject
export const cgetConstantActualValueInConstantLibraryObject_validData = cgetConstantActualValueInConstantLibraryObject + bas.cUnderscore + wrd.cvalid + wrd.cData; // getConstantActualValueInConstantLibraryObject_validData
export const cgetConstantActualValueInConstantLibraryObject_inValidInputDataString = cgetConstantActualValueInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // getConstantActualValueInConstantLibraryObject_inValidInputDataString
export const cgetConstantActualValueInConstantLibraryObject_inValidInputMetaDataString = cgetConstantActualValueInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cString; // getConstantActualValueInConstantLibraryObject_inValidInputMetaDataString
export const cgetConstantActualValueInConstantLibraryObject_inValidInputDataInteger = cgetConstantActualValueInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // getConstantActualValueInConstantLibraryObject_inValidInputDataInteger
export const cgetConstantActualValueInConstantLibraryObject_inValidInputDataBoolean = cgetConstantActualValueInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // getConstantActualValueInConstantLibraryObject_inValidInputDataBoolean
export const cgetConstantActualValueInConstantLibraryObject_inValidInputMetaDataInteger = cgetConstantActualValueInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cInteger; // getConstantActualValueInConstantLibraryObject_inValidInputMetaDataInteger
export const cgetConstantActualValueInConstantLibraryObject_inValidInputMetaDataBoolean = cgetConstantActualValueInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cBoolean; // getConstantActualValueInConstantLibraryObject_inValidInputMetaDataBoolean
export const cgetConstantActualValueInConstantLibraryObject_inValidInputDataUndefined = cgetConstantActualValueInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // getConstantActualValueInConstantLibraryObject_inValidInputDataUndefined
export const cgetConstantActualValueInConstantLibraryObject_inValidInputDataNaN = cgetConstantActualValueInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // getConstantActualValueInConstantLibraryObject_inValidInputDataNaN
export const cgetConstantActualValueInConstantLibraryObject_inValidInputMetaDataUndefined = cgetConstantActualValueInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'Undefined'; // getConstantActualValueInConstantLibraryObject_inValidInputMetaDataUndefined
export const cgetConstantActualValueInConstantLibraryObject_inValidInputMetaDataNaN = cgetConstantActualValueInConstantLibraryObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'NaN'; // getConstantActualValueInConstantLibraryObject_inValidInputMetaDataNaN

// doesConstantExistInConstantNamespaceObject
export const cdoesConstantExistInConstantNamespaceObject_validData = cdoesConstantExistInConstantNamespaceObject + bas.cUnderscore + wrd.cvalid + wrd.cData; // doesConstantExistInConstantNamespaceObject_validData
export const cdoesConstantExistInConstantNamespaceObject_inValidInputDataString = cdoesConstantExistInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // doesConstantExistInConstantNamespaceObject_inValidInputDataString
export const cdoesConstantExistInConstantNamespaceObject_inValidInputMetaDataString = cdoesConstantExistInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cString; // doesConstantExistInConstantNamespaceObject_inValidInputMetaDataString
export const cdoesConstantExistInConstantNamespaceObject_inValidInputDataInteger = cdoesConstantExistInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // doesConstantExistInConstantNamespaceObject_inValidInputDataInteger
export const cdoesConstantExistInConstantNamespaceObject_inValidInputDataBoolean = cdoesConstantExistInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // doesConstantExistInConstantNamespaceObject_inValidInputDataBoolean
export const cdoesConstantExistInConstantNamespaceObject_inValidInputMetaDataInteger = cdoesConstantExistInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cInteger; // doesConstantExistInConstantNamespaceObject_inValidInputMetaDataInteger
export const cdoesConstantExistInConstantNamespaceObject_inValidInputMetaDataBoolean = cdoesConstantExistInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cBoolean; // doesConstantExistInConstantNamespaceObject_inValidInputMetaDataBoolean
export const cdoesConstantExistInConstantNamespaceObject_inValidInputDataUndefined = cdoesConstantExistInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // doesConstantExistInConstantNamespaceObject_inValidInputDataUndefined
export const cdoesConstantExistInConstantNamespaceObject_inValidInputDataNaN = cdoesConstantExistInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // doesConstantExistInConstantNamespaceObject_inValidInputDataNaN
export const cdoesConstantExistInConstantNamespaceObject_inValidInputMetaDataUndefined = cdoesConstantExistInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'Undefined'; // doesConstantExistInConstantNamespaceObject_inValidInputMetaDataUndefined
export const cdoesConstantExistInConstantNamespaceObject_inValidInputMetaDataNaN = cdoesConstantExistInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'NaN'; // doesConstantExistInConstantNamespaceObject_inValidInputMetaDataNaN

// getConstantNameInConstantNamespaceObject
export const cgetConstantNameInConstantNamespaceObject_validData = cgetConstantNameInConstantNamespaceObject + bas.cUnderscore + wrd.cvalid + wrd.cData; // getConstantNameInConstantNamespaceObject_validData
export const cgetConstantNameInConstantNamespaceObject_inValidInputDataString = cgetConstantNameInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // getConstantNameInConstantNamespaceObject_inValidInputDataString
export const cgetConstantNameInConstantNamespaceObject_inValidInputMetaDataString = cgetConstantNameInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cString; // getConstantNameInConstantNamespaceObject_inValidInputMetaDataString
export const cgetConstantNameInConstantNamespaceObject_inValidInputDataInteger = cgetConstantNameInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // getConstantNameInConstantNamespaceObject_inValidInputDataInteger
export const cgetConstantNameInConstantNamespaceObject_inValidInputDataBoolean = cgetConstantNameInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // getConstantNameInConstantNamespaceObject_inValidInputDataBoolean
export const cgetConstantNameInConstantNamespaceObject_inValidInputMetaDataInteger = cgetConstantNameInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cInteger; // getConstantNameInConstantNamespaceObject_inValidInputMetaDataInteger
export const cgetConstantNameInConstantNamespaceObject_inValidInputMetaDataBoolean = cgetConstantNameInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cBoolean; // getConstantNameInConstantNamespaceObject_inValidInputMetaDataBoolean
export const cgetConstantNameInConstantNamespaceObject_inValidInputDataUndefined = cgetConstantNameInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // getConstantNameInConstantNamespaceObject_inValidInputDataUndefined
export const cgetConstantNameInConstantNamespaceObject_inValidInputDataNaN = cgetConstantNameInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // getConstantNameInConstantNamespaceObject_inValidInputDataNaN
export const cgetConstantNameInConstantNamespaceObject_inValidInputMetaDataUndefined = cgetConstantNameInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'Undefined'; // getConstantNameInConstantNamespaceObject_inValidInputMetaDataUndefined
export const cgetConstantNameInConstantNamespaceObject_inValidInputMetaDataNaN = cgetConstantNameInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'NaN'; // getConstantNameInConstantNamespaceObject_inValidInputMetaDataNaN

// getConstantActualValueInConstantNamespaceObject
export const cgetConstantActualValueInConstantNamespaceObject_validData = cgetConstantActualValueInConstantNamespaceObject + bas.cUnderscore + wrd.cvalid + wrd.cData; // getConstantActualValueInConstantNamespaceObject_validData
export const cgetConstantActualValueInConstantNamespaceObject_inValidInputDataString = cgetConstantActualValueInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cString; // getConstantActualValueInConstantNamespaceObject_inValidInputDataString
export const cgetConstantActualValueInConstantNamespaceObject_inValidInputMetaDataString = cgetConstantActualValueInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cString; // getConstantActualValueInConstantNamespaceObject_inValidInputMetaDataString
export const cgetConstantActualValueInConstantNamespaceObject_inValidInputDataInteger = cgetConstantActualValueInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cInteger; // getConstantActualValueInConstantNamespaceObject_inValidInputDataInteger
export const cgetConstantActualValueInConstantNamespaceObject_inValidInputDataBoolean = cgetConstantActualValueInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + wrd.cBoolean; // getConstantActualValueInConstantNamespaceObject_inValidInputDataBoolean
export const cgetConstantActualValueInConstantNamespaceObject_inValidInputMetaDataInteger = cgetConstantActualValueInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cInteger; // getConstantActualValueInConstantNamespaceObject_inValidInputMetaDataInteger
export const cgetConstantActualValueInConstantNamespaceObject_inValidInputMetaDataBoolean = cgetConstantActualValueInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + wrd.cBoolean; // getConstantActualValueInConstantNamespaceObject_inValidInputMetaDataBoolean
export const cgetConstantActualValueInConstantNamespaceObject_inValidInputDataUndefined = cgetConstantActualValueInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'Undefined'; // getConstantActualValueInConstantNamespaceObject_inValidInputDataUndefined
export const cgetConstantActualValueInConstantNamespaceObject_inValidInputDataNaN = cgetConstantActualValueInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputData + 'NaN'; // getConstantActualValueInConstantNamespaceObject_inValidInputDataNaN
export const cgetConstantActualValueInConstantNamespaceObject_inValidInputMetaDataUndefined = cgetConstantActualValueInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'Undefined'; // getConstantActualValueInConstantNamespaceObject_inValidInputMetaDataUndefined
export const cgetConstantActualValueInConstantNamespaceObject_inValidInputMetaDataNaN = cgetConstantActualValueInConstantNamespaceObject + bas.cUnderscore + wrd.cin + wrd.cValid + msg.cInputMetaData + 'NaN'; // getConstantActualValueInConstantNamespaceObject_inValidInputMetaDataNaN
