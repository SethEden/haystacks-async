/**
 * @file test.message.constants.js
 * @module test.message.constants
 * @description Contains many re-usable test message constants.
...
// Unit Test String Parsing
export const cunitTestStringParsingDotCustomEcho = wrd.cclient + wrd.cString + wrd.cParsing + bas.cDot + wrd.ccustom + wrd.cEcho; // clientStringParsing.customEcho
...
export const cresolvedConstantsPath_UnitTestConstantIs = tst_sys.cresolvedConstantsPath_UnitTest + wrd.cConstant + sys.cSpaceIsColonSpace; // resolvedConstantsPath_UnitTestConstant is:
export const cresolvedConstantsPath_UnitTestMessageIs = tst_sys.cresolvedConstantsPath_UnitTest + wrd.cMessage + sys.cSpaceIsColonSpace; // resolvedConstantsPath_UnitTestMessage is:
export const cresolvedConstantsPath_UnitTestSystemIs = tst_sys.cresolvedConstantsPath_UnitTest + wrd.cSystem + sys.cSpaceIsColonSpace; // resolvedConstantsPath_UnitTestSystem is:

export const cunitTestBusinessConstantsPhase1Validation = wrd.cunit + wrd.cTest + bas.cSpace + wrd.cBusiness + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Unit Test Business Constants Phase 1 Validation
export const cunitTestCommandConstantsPhase1Validation = wrd.cunit + wrd.cTest + bas.cSpace + wrd.cCommand + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Unit Test Command Constants Phase 1 Validation
export const cunitTestConfigurationConstantsPhase1Validation = wrd.cunit + wrd.cTest + bas.cSpace + wrd.cConfiguration + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Unit Test Configuration Constants Phase 1 Validation
export const cunitTestConstantsPhase1Validation = wrd.cunit + wrd.cTest + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Unit Test Constants Phase 1 Validation
export const cunitTestMessageConstantsPhase1Validation = wrd.cunit + wrd.cTest + bas.cSpace + wrd.cMessage + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Unit Test Message Constants Phase 1 Validation
export const cunitTestSystemConstantsPhase1Validation = wrd.cunit + wrd.cTest + bas.cSpace + wrd.cSystem + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Unit Test System Constants Phase 1 Validation

export const cunitTestBusinessConstantsPhase2Validation = wrd.cunit + wrd.cTest + bas.cSpace + wrd.cBusiness + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c2 + bas.cSpace + wrd.cValidation; // Unit Test Business Constants Phase 2 Validation
export const cunitTestCommandConstantsPhase2Validation = wrd.cunit + wrd.cTest + bas.cSpace + wrd.cCommand + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c2 + bas.cSpace + wrd.cValidation; // Unit Test Command Constants Phase 2 Validation
export const cunitTestConfigurationConstantsPhase2Validation = wrd.cunit + wrd.cTest + bas.cSpace + wrd.cConfiguration + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c2 + bas.cSpace + wrd.cValidation; // Unit Test Configuration Constants Phase 2 Validation
export const cunitTestConstantsPhase2Validation = wrd.cunit + wrd.cTest + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c2 + bas.cSpace + wrd.cValidation; // Unit Test Constants Phase 2 Validation
export const cunitTestMessageConstantsPhase2Validation = wrd.cunit + wrd.cTest + bas.cSpace + wrd.cMessage + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c2 + bas.cSpace + wrd.cValidation; // Unit Test Message Constants Phase 2 Validation
export const cunitTestSystemConstantsPhase2Validation = wrd.cunit + wrd.cTest + bas.cSpace + wrd.cSystem + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c2 + bas.cSpace + wrd.cValidation; // Unit Test System Constants Phase 2 Validation

// Caught the case that some arguments were passed in as input to the function.
export const cunitTestMessage00 = wrd.cCaught + bas.cSpace + wrd.cthe + bas.cSpace + wrd.ccase + bas.cSpace + wrd.cthat + bas.cSpace + wrd.csome + bas.cSpace + wrd.carguments + bas.cSpace + wrd.cwere + bas.cSpace + wrd.cpassed + bas.cSpace + wrd.cin + bas.cSpace + wrd.cas + bas.cSpace + wrd.cinput + bas.cSpace + wrd.cto + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cfunction + bas.cDot; 
export const cunitTestMessage01 = wrd.cBEGIN + bas.cSpace + wrd.cmain + bas.cSpace + wrd.cprogram + bas.cSpace + wrd.cloop; // BEGIN main program loop
export const cunitTestMessage02 = wrd.cBEGIN + bas.cSpace + wrd.ccommand + bas.cSpace + wrd.cparser; // BEGIN command parser
export const cunitTestMessage03 = wrd.cEND + bas.cSpace + wrd.ccommand + bas.cSpace + wrd.cparser; // END command parser
export const cunitTestMessage04 = wrd.cEND + bas.cSpace + wrd.cmain + bas.cSpace + wrd.cprogram + bas.cSpace + wrd.cloop; // END main program loop
export const cunitTestMessage05 = wrd.cExiting + bas.cSpace + wrd.cTEST + bas.cSpace + wrd.cHARNESS + bas.cSpace + wrd.cUnit + wrd.Test; // Exiting TEST HARNESS UNIT TEST
