...
async function initFrameworkSchema(configData) {
  ...
  let pluginMetaDataPathAndFilename = configData[cfg.cpluginFullMetaDataPath];
  ...
  let pluginMetaData = await ruleBroker.processRules([pluginMetaDataPathAndFilename, ''], getJsonRule);
