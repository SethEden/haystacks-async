...
export const cReleasePath =
  bas.cForwardSlash + wrd.crelease + bas.cForwardSlash; // /release/
export const cForwardSlashPackageDotJson =
  bas.cForwardSlash + sys.cpackageDotJson; // /package.json
