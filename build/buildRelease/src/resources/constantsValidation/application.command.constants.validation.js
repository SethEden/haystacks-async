...
export const applicationCommandConstantsValidation = [
  ...
  },
  {
    ...
    Actual: app_cmd.cdeployMetaData,
    Expected: "deployMetaData",
  },
  {
    Name: "cdeployApplication",
    Actual: app_cmd.cdeployApplication,
    Expected: "deployApplication",
  },
  {
    Name: "creleaseApplication",
    Actual: app_cmd.creleaseApplication,
  ...
  {
    Name: "cBuildWorkflow",
    Actual: app_cmd.cBuildWorkflow,
    Expected: "Workflow build",
  },
  {
    Name: "cReleaseWorkflow",
    Actual: app_cmd.cReleaseWorkflow,
