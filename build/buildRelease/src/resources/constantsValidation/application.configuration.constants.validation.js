...
export const applicationConfigurationConstantsValidation = [
  ...
  {
    Name: "cdestinationPath",
    Actual: app_cfg.cdestinationPath,
    Expected: "destinationPath",
  },
  {
    Name: "csourceResourcesPath",
    Actual: app_cfg.csourceResourcesPath,
    Expected: "sourceResourcesPath",
  },
  {
    Name: "cdestinationResourcesPath",
    Actual: app_cfg.cdestinationResourcesPath,
    Expected: "destinationResourcesPath",
  },
  {
    Name: "creleasePath",
    Actual: app_cfg.creleasePath,
